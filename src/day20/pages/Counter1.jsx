...
const Counter1 = () => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl p-8 w-96 text-center border">
      ...
      <h1 className="text-3xl font-bold text-purple-600 mb-6">Another Counter</h1>

      <h2 className="text-6xl font-bold text-gray-700 mb-8">{count}</h2>

      <div className="flex justify-center gap-3">

        <button onClick={handleIncrement} className="bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded-lg transition">Incremen</button>
