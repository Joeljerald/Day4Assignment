const Login = () => {
  return (
    <div className="min-h-screen flex justify-center items-center bg-slate-600">
      <div className="w-96 bg-slate-200 p-8 rounded-xl shadow-xl">
        <h1 className="text-3xl font-bold text-center mb-6 text-slate-800">Register</h1>

        <div className="mb-4">
          <label className=" mb-2 font-medium text-slate-700">First Name</label>
        ...
        <p className="text-center mt-4 text-slate-600">Do have an account?
          <span className="text-blue-600 font-medium cursor-pointer ml-1">Login</span>
        </p>
      </div>
    </div>
  );
